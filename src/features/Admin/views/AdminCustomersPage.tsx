...
export const AdminCustomersPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-5 max-w-5xl mx-auto pb-[calc(var(--app-bottom-nav-height)+env(safe-area-inset-bottom,0px)+var(--app-bottom-nav-buffer))] md:pb-10">
